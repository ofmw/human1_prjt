...
<style>
    ...
    /*--------------------------------*/
    /*----------- 공지사항(제목) -----------*/
    #div_faqReturn_section p:first-child {
        margin-bottom: 20px;
        width: 200px;
        float: left;
        font-size: 28px;
    ...
    #tbl_contents_menu td:nth-child(4), #tbl_contents_menu td:nth-child(4) a{
        background-color: black;
        color: white;
    }
