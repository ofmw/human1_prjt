$(function() {
    ...
    $("#sns_naver_btn").click(function(){
        ...
        let url = "https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=AdI9mtwo_qO9HcI4nYXD&state=test&redirect_uri=http://localhost:9090/prjt/naverlogin.do";
