...
<body>
        <form action="itNews/write_process.jsp" name="frm_write" method="post" enctype="multipart/form-data" onsubmit="return validateForm();">
            <table class="tbl">
                ...
                <tr>
                    <td colspan="2" id="td_btn">
                        ...
                        <input type="button" value="목록으로" onclick="location.href='itNews.jsp'">
                    </td>
                </tr>
            </table>
        </form>
