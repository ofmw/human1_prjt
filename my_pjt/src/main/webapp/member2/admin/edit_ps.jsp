...
<body>
        <form name="frm_edit" method="post" action="admin/ep_ps.jsp" enctype="multipart/form-data" onsubmit="return validateForm();">
            <table class="tbl">
                ...
                <tr>
                    <td colspan="2" id="td_btn">
                        ...
                        <input type="button" value="목록으로" onclick="location.href='admin2.jsp'">
                    </td>
                </tr>
            </table>
        </form>
