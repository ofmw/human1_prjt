            ...
            <c:otherwise>
                <c:forEach var="rowNum" begin="${startNum}" end="${endNum}">
                    <tr>
                        ...
                        <td id="td_title">
                            <a href="qa3.jsp?no=${boardList[rowNum-1].b_idx}">${boardList[rowNum-1].title}
	                           <c:choose>
	                                <c:when test="${boardList[rowNum-1].c_count gt 0}">
		                                <strong>[${boardList[rowNum-1].c_count}]</strong>
	                                </c:when>
                               </c:choose>
                            </a>
                        </td>
