...
<body>
            ...
            <c:otherwise>
                <c:forEach var="rowNum" begin="${startNum}" end="${endNum}">
                    <tr>
                        ...
                        <td id="td_title">
                            <a href="preset3.jsp?no=${boardList[rowNum-1].b_idx}">${boardList[rowNum-1].title}</a>
                        </td>
                        ...
                        <td style="padding-left:20px">
                            <c:if test="${!empty boardList[rowNum-1].originFile}">
                                <a href="preset/download.jsp?oName=${boardList[rowNum-1].originFile}&sName=${boardList[rowNum-1].saveFile}">
                                    <img src="../resources/img/download.png" width="11px" height="13px" alt="" />
                                </a>
                            </c:if>
                        </td>
                    </tr>
    ...
    <c:if test="${!empty member}">
        <div id="div_write">
            <a href="preset2.jsp"><button id="btn_write">글 작성</button></a>
        </div>
    </c:if>
